...
public class OneGame extends GameEngine {
    ...
    private static final String Dashing_left[] = { "Player1animations/dash/dash1left.png",
            "Player1animations/dash/dash2left.png", "Player1animations/dash/dash3left.png",
            "Player1animations/dash/dash4left.png", "Player1animations/dash/dash5left.png",
            "Player1animations/dash/dash6left.png" };
    private static final String Dashing_right[] = { "Player1animations/dash/dash1right.png",
            "Player1animations/dash/dash2right.png", "Player1animations/dash/dash3right.png",
            "Player1animations/dash/dash4right.png", "Player1animations/dash/dash5right.png",
            "Player1animations/dash/dash6right.png" };
    private static final String Jumping_Image_File_right[] = { "Player1animations/jump/jump1right.png",
            "Player1animations/jump/jump2right.png", "Player1animations/jump/jump3right.png",
            "Player1animations/jump/jump4right.png" };
    private static final String Jumping_Image_File_left[] = { "Player1animations/jump/jump1left.png",
            "Player1animations/jump/jump2left.png", "Player1animations/jump/jump3left.png",
            "Player1animations/jump/jump4left.png" };
    private static final String Running_Image_File_idle_right[] = { "Player1animations/idle/idle1right.png",
            "Player1animations/idle/idle2right.png", "Player1animations/idle/idle3right.png",
            "Player1animations/idle/idle4right.png" };
    private static final String Running_Image_File_idle_left[] = { "Player1animations/idle/idle1left.png",
            "Player1animations/idle/idle2left.png", "Player1animations/idle/idle3left.png",
            "Player1animations/idle/idle4left.png" };
    private static final String Running_Image_File_right[] = { "Player1animations/run/run1right.png",
            "Player1animations/run/run2right.png", "Player1animations/run/run3right.png",
            "Player1animations/run/run4right.png" };
    private static final String Running_Image_File_left[] = { "Player1animations/run/run1left.png",
            "Player1animations/run/run2left.png", "Player1animations/run/run3left.png",
            "Player1animations/run/run4left.png" };
    private static final String backgroundImages[] = { "sprites/Background/Backdrop1.png",
            "sprites/Background/Backdrop2.png", "sprites/Background/Backdrop3.png",
            "sprites/Background/Backdrop4.png" };
    private static final String backgroundImagesDash[] = { "sprites/Background/Backdrop1Dash.png",
            "sprites/Background/Backdrop2Dash.png", "sprites/Background/Backdrop3Dash.png",
            "sprites/Background/Backdrop4Dash.png" };
        ...
        for (int i = 0; i < displayList.size(); i++) {
            if (displayList.get(i) instanceof canCollide) {
                ...
                if (displayList.get(i) instanceof necromancer) {
                    ...
                    if (skull) {
                        Enemies skullProjectile = new Skull((int) (((necromancer) displayList.get(i)).getX()),
                                (int) (((necromancer) displayList.get(i)).getY()));
