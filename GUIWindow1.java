...
public class GUIWindow1 extends JComponent implements KeyListener, MouseListener{
    ...
    private ArrayList<Enemies> displayList;    
    ...
    public GUIWindow1(int windowWidth, int windowHeight, ArrayList<Enemies> displayList){
    ...
    //GetEntities and Sets the current game speed
    //The game speed is represented as integer indicating a percentage.
    //a value of 100 indicates the game is running at 100% speed, ie the default game speed.
    //150 and 50 would indicate game running 50% faster and 50% slower, respectively.    
    ...
    //GetEntity and set current background image
    //bgImageFile is null if no background image is set
    public void setBackgroundImage(String filename){
        bgImageFile = filename;
        backgroundImage = GUIWindow1.readImage(bgImageFile);             
    }
    ...
    public static Image readImage(String filename){
        ...
        URL imageResource = GUIWindow1.class.getResource(filename);
